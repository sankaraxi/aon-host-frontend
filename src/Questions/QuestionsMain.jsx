...
export default function QuestionsMain() {
    ...
    //     try {
    //         const response = await fetch('http://13.202.249.99/api/api/run-script', {
    //             method: 'POST',
    //             headers: {
    ...
    //     try {
    //       const res = await fetch('http://13.202.249.99/api/api/run-script', { method: 'POST' });
    ...
    //   };
      ...
      const handleStartAssessmentII = async (selectedFramework) => {
        ...
        try {
            const res = await fetch('http://13.202.249.99/api/api/run-script', 
                {
                    method: 'POST',
                    headers: {
                      'Content-Type': 'application/json',
